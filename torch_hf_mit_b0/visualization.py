...
def visualize_dataset_samples(ds, num=3):
    ...
    for _ in range(num):
        ...
        # # Image 
        # pred_fig = px.imshow(i.numpy(), color_continuous_scale='gray', binary_string=False)
        ...
        # )
        # eval_fig.show()
        # # eval_fig.write_html(f'/img_mask_{i}.html')
        # # eval_fig.write_image(f"/img_mask_{i}.png")